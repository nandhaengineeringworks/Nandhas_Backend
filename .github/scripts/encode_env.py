...
lines = [
    ...
    f"STORAGE_TYPE={get('V_STORAGE_TYPE', 'local')}",
    f"AWS_REGION={get('V_REGION')}",
    f"AWS_S3_BUCKET={get('V_S3_BUCKET')}",
    f"JWT_SECRET={get('V_JWT')}",
    f"ADMIN_DEFAULT_EMAIL={get('V_ADMIN_EMAIL', 'admin@nandhas.in')}",
    f"ADMIN_DEFAULT_PASSWORD={get('V_ADMIN_PASSWORD', 'Nandhas@123')}",
